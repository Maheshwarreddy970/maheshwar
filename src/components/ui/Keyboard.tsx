...
export const Keypad = () => {
    return (
        <div className="absolute group  origin-top top-2 h-[400px] w-[600px]   transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:scale-105">
            <div className="h-full w-full rounded-md  ">
                ...
                <Row>
                    ...
                    <KBtn>
                        <IconBrightnessDown className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F1</span>
                    </KBtn>

                    <KBtn>
                        <IconBrightnessUp className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F2</span>
                    </KBtn>
                    <KBtn>
                        <IconTable className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F3</span>
                    </KBtn>
                    <KBtn>
                        <IconSearch className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F4</span>
                    </KBtn>
                    <KBtn>
                        <IconMicrophone className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F5</span>
                    </KBtn>
                    <KBtn>
                        <IconMoon className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F6</span>
                    </KBtn>
                    <KBtn>
                        <IconPlayerTrackPrev className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F7</span>
                    </KBtn>
                    <KBtn>
                        <IconPlayerSkipForward className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F8</span>
                    </KBtn>
                    <KBtn>
                        <IconPlayerTrackNext className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F8</span>
                    </KBtn>
                    <KBtn>
                        <IconVolume3 className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F10</span>
                    </KBtn>
                    <KBtn>
                        <IconVolume2 className="h-[10px] w-[10px]" />
                        <span className="inline-block mt-1">F11</span>
                    </KBtn>
                    <KBtn>
                        <IconVolume className="h-[10px] w-[10px]" />
                ...
                <Row>
                    ...
                    <div className="w-[4.9rem] mt-[2px] h-6 p-[0.5px] rounded-[4px] flex flex-col justify-end items-center">
                        <KBtn className="w-6 h-3">
                            <IconCaretUpFilled className="h-[10px] w-[10px]" />
                        </KBtn>
                        <div className="flex">
                            <KBtn className="w-6 h-3">
...
export const KBtn = ({
    ...
    return (
        <div
            className={cn(
                "p-[0.5px] rounded-[4px]",
                backlit && "bg-white/[0.2] group-hover:shadow-red-600 shadow-xl shadow-white"
            )}
        >
            <div
                className={cn(
