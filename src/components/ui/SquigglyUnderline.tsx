      ...
      {navigation.map((item) => {
        ...
        return (
          <Link
            key={item}
            href={`#${item}`}
            className={`relative capitalize text-xs sm:text-sm leading-6 no-underline ${
              isSelected ? "font-semibold text-black dark:text-white" : "text-gray-800 dark:text-gray-300"
            }`}
